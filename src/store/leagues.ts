...
class LeaguesModule extends VuexModule {
  ...
  stats:Ileader[] = []
  url:URL = {
    PremierLeague:"https://site.api.espn.com/apis/v2/sports/soccer/eng.1/standings",
  ...
  stats_url:URL={
    PremierLeague:"http://site.api.espn.com/apis/site/v2/sports/soccer/eng.1/statistics",
    Laliga:"http://site.api.espn.com/apis/site/v2/sports/soccer/esp.1/statistics",
    Ligue1:"http://site.api.espn.com/apis/site/v2/sports/soccer/fra.1/statistics",
    Bundesliga:"http://site.api.espn.com/apis/site/v2/sports/soccer/ger.1/statistics",
    SerieA:"http://site.api.espn.com/apis/site/v2/sports/soccer/ita.1/statistics"
  }
  // mutations
  @Mutation
